...
# Как сделать загрузочную флешку на сборки от Eagle123
...
# Как сделать загрузочную флешку на другие сборки

## Создать загрузочную флешку:
	
	1. Запустить Rufus
	2. Выбрать .iso
	3. Выбрать схему раздела в соответствии с вашим диском
	4. нажать "старт"
	
## Установка:

	1. При запуске с флешки запуститься превью версия винды с 1 запущеной прогой
	2. В ней нажать Install нижняя кнопка, потом options, выбрать в выпадающем списке последнюю версию, нажать установка
